...
export default async function VerkehrPage({
  searchParams,
}: {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-stone-50 to-stone-100 text-stone-800">
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <h1 className="mt-4 text-3xl font-semibold tracking-tight">Verkehr</h1>
        <p className="mt-3 text-stone-600">
          Informationen zum ÖPNV werden hier in Kürze ergänzt.
        </p>
      </div>
    </main>
  );
